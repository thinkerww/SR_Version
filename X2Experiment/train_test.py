...
train_set = DatasetFromHdf5("/dataset/1/wangwei/x2/val_DIV2K_100_4.h5")
...
def test2(epoch,path):
    ...
    # 读取 测试文件的 数据集 
    imageset = '/dataset/1/wangwei/Set5-output-2'
...
def save_checkpoint(epoch):
    model_out_path = "/dataset/1/wangwei/x2/x2_test/Output/" + "model_{}_epoch_{}.pth".format(opt.lr,epoch)
    state = {"epoch": epoch ,"model": model}
    if not os.path.exists("/dataset/1/wangwei/x2/x2_test/Output/"):
        os.makedirs("/dataset/1/wangwei/x2/x2_test/Output/")
